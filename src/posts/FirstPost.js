...
To be more specific, they were using custom elements in combination with Shadow DOM. 

> Throughout this post, I will name which parts of the webcomponent
  spec I am referring to, as I believe this is a better way to discuss this topic.
...
was to create a full-fledged UI library built with custom elements and Shadow DOM.
...
In my opinion, this is the true promise of using web components.

This resulted into us trying to fit simple and complex UI patterns into a 
custom element with shadow DOM. For example if we look at the UI pattern of a 
card. We were passing attribtes to the custom element like this:
...
to be enabled for the UI to function. Therefore we looked tried to explore other 
options.
